...
export default function BaccaratTable({ balance, totalLost, onUpdateBalance, onClose }: BaccaratTableProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-2 md:p-4 overflow-y-auto">
      <div className="relative w-full max-w-5xl bg-emerald-900 border-4 md:border-8 border-amber-900 rounded-[2rem] md:rounded-[3rem] p-4 md:p-8 shadow-2xl overflow-hidden min-h-[600px] md:min-h-0">
        <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ 
          backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)',
          backgroundSize: '40px 40px'
        }} />

        <button onClick={onClose} className="absolute top-4 right-4 md:top-6 md:right-6 text-emerald-200 hover:text-white transition-colors z-10">
